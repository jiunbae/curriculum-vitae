...
\outerlist{
    ...
    \innerlist{
        \entry{Developed and improved a end-to-end speech recognition model, enhancing the accuracy and efficiency of voice-based applications and optimizing it for real-time.}
